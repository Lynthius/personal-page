  ...
  resources: {
    ...
    pl: {
      translation: {
        ...
        aboutSection: `Cześć! Mam na imię Tomasz i jestem <a href="https://www.instagram.com/tomasz_przyborowski/" target="_blank"><span class="highlight">fotografem produktowym</span></a> oraz <a href="https://github.com/Lynthius" target="_blank"> <span class="highlight">web developerem</span></a> z Poznania. Interesują mnie technologie związane z front-endem, szczególnie JavaScript. Aktualnie jestem w trakcie nauki React'a oraz Typescript'a. Jestem również twórcą inicjatywy <a href="https://github.com/yllwduck" target="_blank"><span class="highlight">yllwduck</span></a> - miejsca dla ludzi chcących się uczyć, lub dzielić wiedzą z zakresu web-dev'u oraz członkiem organizacji <a href="https://github.com/CodersCrew/" target="_blank"><span class="highlight">CodersCrew</span></a>.`,
