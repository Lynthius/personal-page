...
const photoTitleSection = document.querySelector(".translate__title_photography");
const sectionDescLeft = document.querySelector(".section-description-left_subtitle");
const sectionDescRight = document.querySelector(".section-description-right_subtitle");
  ...
  resources: {
    en: {
      translation: {
        ...
        question1: `<button class="accordion__link" aria-controls="answer-1" aria-expanded="false">Na czym polega fotografia produktowa?<span class="add">+</span><span class="remove">-</span></button>`,
